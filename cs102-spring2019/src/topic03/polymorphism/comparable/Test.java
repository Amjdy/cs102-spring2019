...
public class Test {
    public static void main(String []args){
        ...
        Collections.sort(studentList, lnc);
        System.out.println("studentList after sorting: "+ studentList);
        System.out.println("max value: "+ Collections.max(studentList, fnc));
        System.out.println("min value: "+ Collections.min(studentList, fnc));
